    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בדיקת רווחיות למסעדות- profit משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2aec17b9-8605-421d-84cc-bd4a0427844a',
                    name: data.name || '',
                    email: data.email || '',
